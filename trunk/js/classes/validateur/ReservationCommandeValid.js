;function ReservationCommandeValid() { 
	this.validAjout = function(pData) { 
		...
		//Tests Techniques
		if(!pData.stoQuantite.checkLength(0,12) || pData.stoQuantite > 999999999.99) {lVR.valid = false;lVR.stoQuantite.valid = false;var erreur = new VRerreur();erreur.code = ERR_101_CODE;erreur.message = ERR_101_MSG;lVR.stoQuantite.erreurs.push(erreur);}
