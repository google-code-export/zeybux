...
include_once(CHEMIN_CLASSES_VALIDATEUR . MOD_COMPTE_ZEYBU . "/RemiseChequeValid.php");
include_once(CHEMIN_CLASSES_VALIDATEUR . MOD_COMPTE_ZEYBU . "/OperationRemiseChequeValid.php");
...
include_once(CHEMIN_CLASSES_RESPONSE . MOD_COMPTE_ZEYBU . "/RemiseChequeResponse.php" );
include_once(CHEMIN_CLASSES_RESPONSE . MOD_COMPTE_ZEYBU . "/ListeRemiseChequeResponse.php" );
...
class RemiseChequeControleur
{
	...
	*/
	...
	public function getListeRemiseChequeActive() {			
		...
		$lRemiseChequeService = new RemiseChequeService();			
		return new ListeRemiseChequeResponse($lRemiseChequeService->getByCompte(-1,0));
	}
	...
	public function getListeRemiseChequeEncaissee() {
		// Retrourne la liste des remises de chèques actives
		$lRemiseChequeService = new RemiseChequeService();
		return new ListeRemiseChequeResponse($lRemiseChequeService->getByCompte(-1,1));
	}
