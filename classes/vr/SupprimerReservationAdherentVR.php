...
// Fichier : SupprimerReservationAdherentVR.php
//
// Description : Classe SupprimerReservationAdherentVR
//
//****************************************************************
 ...
 * @since 26/01/2011
 * @desc Classe représentant une SupprimerReservationAdherentVR
 */
class SupprimerReservationAdherentVR extends DataTemplate
{
	/**
	 * @var bool
	...
	/**
	 * @var VRelement
	 * @desc Id_commande de la SupprimerReservationAdherentVR
	 */
	protected $mId_commande;

	/**
	 * @var VRelement
	 * @desc Id_adherent de la SupprimerReservationAdherentVR
	 */
	...
	* @desc Constructeur
	*/
	function SupprimerReservationAdherentVR() {
		$this->mValid = true;
