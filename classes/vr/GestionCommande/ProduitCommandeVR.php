...
class ProduitCommandeVR extends DataTemplate
{
	...
	/**
	 * @var integer 
	 * @desc IDCompteProducteur de la ProduitCommandeVR
	 */
	...
	*/
	function ProduitCommandeVR() {
		...
		$this->mIdCompteProducteur = new VRelement();
	...
	* @return VRelement
	* @desc Renvoie le VRelement IdCompteProducteur
	*/
	...
	* @param VRelement
	* @desc Remplace le VRelement IdCompteProducteur par $pIdCompteProducteur
	*/
