...
class StockProduitViewManager
{
	...
	*/
	...
	/**
	* @name selectByIdCommande($pId)
	* @param integer
	* @return StockProduitViewVO
	* @desc Récupère la ligne correspondant à l'id en paramètre, créé une StockProduitViewVO contenant les informations et la renvoie
	*/
	public static function selectByIdCommande($pIdCommande) {
		return StockProduitViewManager::recherche(
	...
	*/
	public static function recherche( $pTypeRecherche, $pTypeCritere, $pCritereRecherche, $pTypeTri, $pCritereTri ) {
		...
		$lRequete = DbUtils::prepareRequeteRecherche(StockProduitViewManager::VUE_STOCKPRODUIT, $lChamps, $pTypeRecherche, $pTypeCritere, $pCritereRecherche, $pTypeTri, $pCritereTri);
	...
	/**
	* @name remplir($pProId, $pProIdCommande, $pProIdNomProduit, $pStoQuantite)
	* @param int(11)
	* @param int(11)
	* @param int(11)
	* @param decimal(32,2)
