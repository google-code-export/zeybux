...
define("VUE_STOCKLIVRAISON", MYSQL_DB_PREFIXE . "view_stock_livraison");
/**
...
class StockLivraisonViewManager
{
	...
	* @param integer
	* @return array(StockLivraisonViewVO)
	* @desc Récupères toutes les lignes de la table ayant pour IdProducteur $pIdProducteur. Puis les renvoie sous forme d'une collection de StockLivraisonViewVO
	*/
	public static function selectByIdProducteur($pIdProducteur) {
		return StockLivraisonViewManager::recherche(
