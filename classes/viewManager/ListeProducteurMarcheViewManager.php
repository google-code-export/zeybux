...
class ListeProducteurMarcheViewManager
{
	...
	*/
	...
	/**
	* @name remplir($pProIdCommande, $pPrdtIdCompte, $pPrdtNom, $pPrdtPrenom)
	* @param int(11)
	* @param int(11)
	* @param varchar(50)
	* @param varchar(50)
	...
	*/
	private static function remplir($pProIdCommande, $pPrdtIdCompte, $pPrdtNom, $pPrdtPrenom) {
		$lListeProducteurMarche = new ListeProducteurMarcheViewVO();
		$lListeProducteurMarche->setProIdCommande($pProIdCommande);
		$lListeProducteurMarche->setPrdtIdCompte($pPrdtIdCompte);
		$lListeProducteurMarche->setPrdtNom($pPrdtNom);
		$lListeProducteurMarche->setPrdtPrenom($pPrdtPrenom);
