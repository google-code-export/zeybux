...
// Fichier : GestionListeCommandeResponse.php
//
// Description : Classe GestionListeCommandeResponse
//
//****************************************************************
include_once(CHEMIN_CLASSES . "DataTemplate.php");

/**
 * @name GestionListeCommandeResponse
 * @author Julien PIERRE
 * @since 17/10/2010
 * @desc Classe représentant une GestionListeCommandeResponse
 */
class GestionListeCommandeResponse extends DataTemplate
{
	/**
	 * @var bool
