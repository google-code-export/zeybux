...
class StockSolidaireManager
{
	...
	const CHAMP_STOCKSOLIDAIRE_DATE_CEATION = "stosol_date_creation";
	...
	*/
	...
	/**
	* @name remplirStockSolidaire($pId, $pIdNomProduit, $pQuantite, $pUnite, $pDateCreation, $pDateModification, $pEtat)
	* @param int(11)
	* @param int(11)
	* @param decimal(10,2)
	* @param varchar(20)
	...
	*/
	private static function remplirStockSolidaire($pId, $pIdNomProduit, $pQuantite, $pUnite, $pDateCreation, $pDateModification, $pEtat) {
		...
		$lStockSolidaire->setDateCreation($pDateCreation);
		...
		$lRequete = 
			"UPDATE " . StockSolidaireManager::TABLE_STOCKSOLIDAIRE . "
			 SET
				...
				," . StockSolidaireManager::CHAMP_STOCKSOLIDAIRE_DATE_CEATION . " = '" . StringUtils::securiser( $pVo->getDateCreation() ) . "'
