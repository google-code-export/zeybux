...
class DetailMarcheViewManager
{
	...
	*/
	...
	/**
	* @name selectProduitAbonnementMarcheActifByIdNomProduit($pId)
	* @param integer
	* @return array(DetailMarcheViewVO)
	* @desc Sélectionne les lignes en fonction de IdProduit
	*/
	public static function selectProduitAbonnementMarcheActifByIdNomProduit($pIdNomProduit) {
		// Initialisation du Logger
		$lLogger = &Log::singleton('file', CHEMIN_FICHIER_LOGS);
		$lLogger->setMask(Log::MAX(LOG_LEVEL));
	...
	*/
	...
	/**
	* @name selectByIdDetailCommande($pIdDetailCommande)
	* @param arra(integer)
	* @return array(DetailMarcheViewVO)
	* @desc Sélectionne les lignes en fonction de IdDetailCommande
	*/
	public static function selectByIdDetailCommande( $pIdDetailCommande ) {
		// Initialisation du Logger
		$lLogger = &Log::singleton('file', CHEMIN_FICHIER_LOGS);
		$lLogger->setMask(Log::MAX(LOG_LEVEL));
