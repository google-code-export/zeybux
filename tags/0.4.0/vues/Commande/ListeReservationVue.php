...
if( isset($_SESSION[DROIT_ID]) && ( isset($_SESSION[MOD_COMMANDE]) || isset($_SESSION[DROIT_SUPER_ZEYBU]) ) ) {
	...
	echo $lControleur->getListeReservationEnCours($_SESSION[DROIT_ID])->exportToJson();

	$lLogger->log("Affichage de la vue ListeReservation par le compte de l'Adhérent : " . $_SESSION['id'],PEAR_LOG_INFO);	// Maj des logs
