...
class CompteZeybuCaisseViewManager
{
	...
	*/
	public static function recherche( $pTypeRecherche, $pTypeCritere, $pCritereRecherche, $pTypeTri, $pCritereTri ) {
		...
		$lRequete = DbUtils::prepareRequeteRecherche(CompteZeybuCaisseViewManager::VUE_COMPTEZEYBUCAISSE, $lChamps, $pTypeRecherche, $pTypeCritere, $pCritereRecherche, $pTypeTri, $pCritereTri);
