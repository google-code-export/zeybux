...
class ProducteurViewManager
{
	...
	*/
	public static function recherche( $pTypeRecherche, $pTypeCritere, $pCritereRecherche, $pTypeTri, $pCritereTri ) {
		...
		if($pTypeTri == '') {
			$pTypeTri = ProducteurManager::CHAMP_PRODUCTEUR_ID;
		}

		$lTris = array( array('champ' => StringUtils::securiser($pTypeTri), 'sens'=> StringUtils::securiser($pCritereTri)) );

		// Préparation de la requète de recherche
		$lRequete = DbUtils::prepareRequeteRecherche(ProducteurViewManager::VUE_PRODUCTEUR, $lChamps, $lFiltres, $lTypeFiltre, $lTris);
