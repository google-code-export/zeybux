 ...
 */
class OperationPasseeViewVO
{
	/**
	* @var int(11)
	* @desc AdhId de la OperationPasseeViewVO
	*/
	private $mAdhId;
	...
	*/
	private $mTppChampComplementaire;

	/**
	* @var varchar(30)
	* @desc TppLabelChampComplementaire de la OperationPasseeViewVO
	*/
	private $mTppLabelChampComplementaire;

	/**
	* @var varchar(50)
	* @desc OpeTypePaiementChampComplementaire de la OperationPasseeViewVO
	*/
	private $mOpeTypePaiementChampComplementaire;

	/**
	* @name getAdhId()
	* @return int(11)
	* @desc Renvoie le membre AdhId de la OperationPasseeViewVO
	*/
	...
	* @param int(11)
	* @desc Remplace le membre AdhId de la OperationPasseeViewVO par $pAdhId
	*/
