...
class MessagesErreurs
{
	...
	const ERR_112_MSG = 'Des éléments sont encore en édition.';
	...
	const ERR_252_MSG = 'La date de fin doit être postérieure à celle de début.';
	...
	const ERR_269_CODE = 269;
	const ERR_269_MSG = 'Il faut un type d\'ahdésion au minimum.';
	const ERR_270_CODE = 270;
	const ERR_270_MSG = 'Cet adhérent est déjà sur cette adhésion.';
	const ERR_271_CODE = 271;
	...
	const ERR_362_MSG = 'Bon de Livraison enregistré.';
	const ERR_363_CODE = 363;
	const ERR_363_MSG = 'Bon de Livraison supprimé.';
	const ERR_364_CODE = 364;
	const ERR_364_MSG = 'Adhésion ajoutée.';
	const ERR_365_CODE = 365;
