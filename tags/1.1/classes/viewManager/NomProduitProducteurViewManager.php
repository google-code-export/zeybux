...
define("VUE_NOMPRODUITPRODUCTEUR", MYSQL_DB_PREFIXE . "view_nom_produit_producteur");
/**
...
{
	const VUE_NOMPRODUITPRODUCTEUR = VUE_NOMPRODUITPRODUCTEUR;
	...
	*/
	...
	/**
	* @name remplir($pNPrdtIdNomProduit, $pPrdtId, $pPrdtNom, $pPrdtPrenom, $pPrdtCommentaire, $pNPrdtId)
	* @param int(11)
	* @param int(11)
	* @param varchar(50)
	* @param varchar(50)
	...
	*/
	private static function remplir($pNPrdtIdNomProduit, $pPrdtId, $pPrdtNom, $pPrdtPrenom, $pPrdtCommentaire, $pNPrdtId) {
		...
		$lNomProduitProducteur->setNPrdtId($pNPrdtId);
