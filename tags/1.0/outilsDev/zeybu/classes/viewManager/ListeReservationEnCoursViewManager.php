...
class ListeReservationEnCoursViewManager
{
	...
	*/
	public static function recherche( $pTypeRecherche, $pTypeCritere, $pCritereRecherche, $pTypeTri, $pCritereTri ) {
		...
		$lRequete = DbUtils::prepareRequeteRecherche(ListeReservationEnCoursViewManager::VUE_LISTERESERVATIONENCOURS, $lChamps, $lFiltres, $lTypeFiltre, $lTris);
	...
	/**
	* @name remplirListeReservationEnCours($pAdhId, $pAdhNumero, $pAdhIdCompte, $pAdhSuperZeybu, $pComId, $pComNumero, $pComDateMarcheDebut, $pComDateMarcheFin, $pComDateFinReservation, $pComArchive)
	* @param int(11)
	* @param varchar(5)
	* @param int(11)
	* @param tinyint(1)
