...
class ListeCommandeEnCoursViewManager
{
	...
	*/
	public static function recherche( $pTypeRecherche, $pTypeCritere, $pCritereRecherche, $pTypeTri, $pCritereTri ) {
		...
		$lRequete = DbUtils::prepareRequeteRecherche(ListeCommandeEnCoursViewManager::VUE_LISTECOMMANDEENCOURS, $lChamps, $lFiltres, $lTypeFiltre, $lTris);
	...
	/**
	* @name remplirListeCommandeEnCours($pComId, $pComNumero, $pComDateFinReservation, $pComDateMarcheDebut, $pComDateMarcheFin)
	* @param int(11)
	* @param int(11)
	* @param datetime
	* @param datetime
