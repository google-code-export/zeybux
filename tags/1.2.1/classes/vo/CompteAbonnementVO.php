...
class CompteAbonnementVO  extends DataTemplate
{
	...
	*/
	...
	/**
	* @var int(11)
	* @desc IdLotAbonnement de la CompteAbonnementVO
	*/
	...
	* @return int(11)
	* @desc Renvoie le membre IdLotAbonnement de la CompteAbonnementVO
	*/
	public function getIdLotAbonnement() {
		return $this->mIdLotAbonnement;
	}

	/**
	* @name setIdLotAbonnement($pIdLotAbonnement)
	* @param int(11)
	* @desc Remplace le membre IdLotAbonnement de la CompteAbonnementVO par $pIdLotAbonnement
	*/
	public function setIdLotAbonnement($pIdLotAbonnement) {
		$this->mIdLotAbonnement = $pIdLotAbonnement;
	}
