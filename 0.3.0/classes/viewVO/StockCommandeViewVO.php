...
class StockCommandeViewVO  extends DataTemplate	
{
	...
	/**
	* @var int(11)
	* @desc ProIdCommande de la StockCommandeViewVO
	*/
	...
	* @return int(11)
	* @desc Renvoie le membre ProIdCommande de la StockCommandeViewVO
	*/
	...
	* @param int(11)
	* @desc Remplace le membre ProIdCommande de la StockCommandeViewVO par $pProIdCommande
	*/
