		...
		switch($_GET["fonction"]) {					
			...
			case "modifierForm":
					 if(isset($_GET["id_marche"])) {
						...
						$lTemplate->assign_vars( array(
													'FORM_ACTION' => "./index.php?m=MarcheHTML&v=AfficherReservation&fonction=modifierValider&id_marche=" . $_GET["id_marche"],
													'idMarche' => $_GET["id_marche"],
													'sigleMonetaire' => SIGLE_MONETAIRE,
													'solde' => StringUtils::affichageMonetaireFr($lSolde),
													'soldeNv' => StringUtils::affichageMonetaireFr($lSoldeNv),
			...
			case "modifierRetourForm":
				if(isset($_GET["id_marche"])) {	
					header('location:./index.php?m=MarcheHTML&v=AfficherReservation&fonction=modifierForm&id_marche=' . $_GET["id_marche"]);
				}
			break;
			...
			case "supprimer":
				if(isset($_GET["id_marche"])) { // Redirection pour contourner un bug
					header('location:./index.php?m=MarcheHTML&v=AfficherReservation&fonction=supprimerAction&id_marche=' . $_GET["id_marche"]);
				}
				break;
			...
			case "supprimerAction":
				if(isset($_GET["id_marche"])) {
					...
					if($lPage->getValid()) {
						...
						$_SESSION['msg'] = $lPage->exportToArray();
						header('location:./index.php?m=MarcheHTML&v=AfficherReservation&fonction=supprimerValider&id_marche=' . $_GET["id_marche"]);
					}
				}
				break;	
