...
class ProduitsBonDeCommandeVR extends DataTemplate
{
	...
	/**
	 * @var VRelement
	 * @desc Export de la ProduitsBonDeCommandeVR
	 */
	protected $mExport;
	...
	* @name getExport()
	* @return VRelement
	* @desc Renvoie le VRelement mExport
	*/
	...
	/**
	* @name setExport($pExport)
	* @param VRelement
	* @desc Remplace le mExport par $pExport
	*/
	public function setExport($pExport) {
		$this->mExport = $pExport;
	}
