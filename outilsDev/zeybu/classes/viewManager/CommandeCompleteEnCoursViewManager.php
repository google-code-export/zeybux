...
class CommandeCompleteEnCoursViewManager
{
	...
	*/
	public static function recherche( $pTypeRecherche, $pTypeCritere, $pCritereRecherche, $pTypeTri, $pCritereTri ) {
		...
		$lRequete = DbUtils::prepareRequeteRecherche(CommandeCompleteEnCoursViewManager::VUE_COMMANDECOMPLETEENCOURS, $lChamps, $lFiltres, $lTypeFiltre, $lTris);
	...
	/**
	* @name remplirCommandeCompleteEnCours($pComId, $pComNumero, $pComNom, $pComDescription, $pComDateMarcheDebut, $pComDateMarcheFin, $pComDateFinReservation, $pComArchive, $pProId, $pProIdCommande, $pProIdNomProduit, $pProUniteMesure, $pProMaxProduitCommande, $pNproId, $pNproNom, $pNproDescription, $pNproIdCategorie, $pDcomId, $pDcomIdProduit, $pDcomTaille, $pDcomPrix)
	* @param int(11)
	* @param int(11)
	* @param varchar(100)
	* @param text
