					...
					"<tbody>" +
						...
						"<tr class=\"ligne-produit\" data-id-produit=\"{categories.produits.id}\" data-id-nom-produit=\"{categories.produits.nproId}\" data-id-categorie=\"{categories.cproId}\" >" +
							...
							"<td class=\"input-formulaire-achat-produit\" >" +
								"<input type=\"text\" id=\"produits{categories.produits.id}quantite\" class=\"produit-quantite com-numeric com-input-text ui-widget-content ui-corner-all\" maxlength=\"12\" size=\"3\" data-id-produit=\"{categories.produits.id}\" data-id-nom-produit=\"{categories.produits.nproId}\" data-type=\"\" />" +
							"</td>" +
							"<td class=\"formulaire-achat-produit-unite\">" +
								"{categories.produits.unite}" +
							"</td>" +
							"<td class=\"input-formulaire-achat-produit\">" +
								"<input type=\"text\" id=\"produits{categories.produits.id}montant\" class=\"produit-prix com-numeric com-input-text ui-widget-content ui-corner-all\" maxlength=\"12\" size=\"3\" data-id-produit=\"{categories.produits.id}\" data-id-nom-produit=\"{categories.produits.nproId}\" data-type=\"\" />" +
							"</td>" +
							...
							// Achat Solidaire		
							"<td class=\"input-formulaire-achat-produit\">" +
								"<input type=\"text\" id=\"produits{categories.produits.id}quantiteSolidaire\" class=\"produit-quantite-solidaire com-numeric com-input-text ui-widget-content ui-corner-all\" maxlength=\"12\" size=\"3\" data-id-produit=\"{categories.produits.id}\" data-id-nom-produit=\"{categories.produits.nproId}\" data-type=\"Solidaire\" />" +
							"</td>" +
							"<td class=\"formulaire-achat-produit-unite\">" +
								"{categories.produits.unite}" +
							"</td>" +
							"<td class=\"input-formulaire-achat-produit\">" +
								"<input type=\"text\" id=\"produits{categories.produits.id}montantSolidaire\" class=\"produit-prix-solidaire com-numeric com-input-text ui-widget-content ui-corner-all\" maxlength=\"12\" size=\"3\" data-id-produit=\"{categories.produits.id}\" data-id-nom-produit=\"{categories.produits.nproId}\" data-type=\"Solidaire\" />" +
							"</td>" +
							"<td class=\"formulaire-achat-produit-sigle-monetaire\">" +
								"{sigleMonetaire}" +
							"</td>" +
