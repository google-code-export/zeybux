function IdentificationValid() { 
	this.validAjout = function(pData) { 
		...
		//Tests Techniques
		if(!pData.login.checkLength(0,5)) {lVR.valid = false;lVR.login.valid = false;var erreur = new VRerreur();erreur.code = ERR_101_CODE;erreur.message = ERR_101_MSG;lVR.login.erreurs.push(erreur);}
