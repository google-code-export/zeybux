...
class ListeLotAbonnementViewManager
{
	...
	*/
	...
	/**
	* @name selectByIdProduitAbonnement($pId)
	* @param integer
	* @return array(ListeLotAbonnementViewVO)
	* @desc Récupères toutes les lignes de la table ayant pour IdProduitAbonnement $pId et les renvoie sous forme d'une collection de ListeLotAbonnementViewVO
	*/
	public static function selectByIdProduitAbonnement($pId) {		
		return ListeLotAbonnementViewManager::recherche(
			array(LotAbonnementManager::CHAMP_LOTABONNEMENT_ID_PRODUIT_ABONNEMENT),
			array('='),
			array($pId),
			array(''),
			array(''));
	...
	*/
	...
	/**
	* @name remplir($pId, $pIdProduitAbonnement, $pTaille, $pPrix)
	* @param int(11)
	* @param int(11)
	* @param decimal(10,2) 	
	* @param decimal(10,2) 	
	...
	*/
	private static function remplir($pId, $pIdProduitAbonnement, $pTaille, $pPrix) {
		$lListeLotAbonnement = new ListeLotAbonnementViewVO();
		$lListeLotAbonnement->setId($pId);
		$lListeLotAbonnement->setIdProduitAbonnement($pIdProduitAbonnement);
		$lListeLotAbonnement->setTaille($pTaille);
		$lListeLotAbonnement->setPrix($pPrix);
