...
include_once(CHEMIN_CLASSES_VR . MOD_CAISSE . "/RechargementCompteVR.php" );
...
class RechargementCompteValid
{
	...
	*/
	public static function validUpdate($pData) {
		$lVr = RechargementCompteValid::validDelete($pData);
		if($lVr->getValid()) {
			return RechargementCompteValid::validAjout($pData);
		}
		return $lVr;
	}
