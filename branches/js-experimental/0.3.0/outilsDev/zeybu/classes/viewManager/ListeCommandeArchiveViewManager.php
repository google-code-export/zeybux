...
class ListeCommandeArchiveViewManager
{
	...
	*/
	public static function recherche( $pTypeRecherche, $pTypeCritere, $pCritereRecherche, $pTypeTri, $pCritereTri ) {
		...
		$lRequete = DbUtils::prepareRequeteRecherche(ListeCommandeArchiveViewManager::VUE_LISTECOMMANDEARCHIVE, $lChamps, $lFiltres, $lTypeFiltre, $lTris);
	...
	/**
	* @name remplirListeCommandeArchive($pComId, $pComNumero, $pComDateFinReservation, $pComDateMarcheDebut, $pComDateMarcheFin)
	* @param int(11)
	* @param int(11)
	* @param datetime
	* @param datetime
