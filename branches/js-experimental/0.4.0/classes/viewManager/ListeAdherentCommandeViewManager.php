...
class ListeAdherentCommandeViewManager
{
	...
	*/
	public static function recherche( $pTypeRecherche, $pTypeCritere, $pCritereRecherche, $pTypeTri, $pCritereTri ) {
		...
		$lRequete = DbUtils::prepareRequeteRecherche(ListeAdherentCommandeViewManager::VUE_LISTEADHERENTCOMMANDE, $lChamps, $pTypeRecherche, $pTypeCritere, $pCritereRecherche, $pTypeTri, $pCritereTri);
	...
	*/
	private static function remplir($pComId, $pComNumero, $pAdhId, $pAdhNumero, $pAdhLabelCompte, $pAdhNom, $pAdhPrenom) {
		...
		$lListeAdherentCommande->setComNumero($pComNumero);
