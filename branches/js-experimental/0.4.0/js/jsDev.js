	...
	this.formulaireAjoutCommande = 
		...
		'<div id="formulaire_ajout_commande_ext">' +
			...
			'<div class="com-widget-window ui-widget ui-widget-content ui-corner-all">' +
				'<div class="com-widget-header ui-widget ui-widget-header ui-corner-all">Nouvelle commande</div>' +
				'<div class="com-widget-content">' +		
					'<form id="formulaire-information-creation-commande">' +
						'<table class="com-table-form">' +
							'<tr>' +
								'<th class="com-table-form-th ui-widget-content ui-corner-all">Nom de la commande</th>' +
							...
							'</tr>' +
							'<tr>' +
								'<th class="com-table-form-th ui-widget-content ui-corner-all">Fin des commandes *</th>' +
						...
						'<table class="com-table-form">' +
							'<tr>' +
								...
								'<td class="com-table-form-td" id="ajout-produit-nom">' +
									...
									'</select>' +
								'</td>' +
								'<td style="text-align:center;"><button type="button" id="btn-creer-nv-pdt">Créer un nouveau produit</button></td>' +
							'</tr>' +
							'<tr>' +
							...
							'</tr>' +
							'<tr>' +
								'<td colspan="3" style="text-align:center;"><input style="width:50%;" type="submit" value="Ajouter à la commande"/></td>' +
							'</tr>' +
						'</table>' +
					'</form>' +
				'</div>' +
			...
			'<div class="com-widget-window ui-widget ui-widget-content ui-corner-all">' +
				'<button type="button" id="btn-modifier-creation-commande" class="ui-helper-hidden">Modifier la commande</button>' +
				'<button type="button" id="btn-creer-commande">Créer la commande</button>' +
			'</div>' +
		'</div>' +	
		'</div>';
...
function MonCompteTemplate() {
	...
	"<div id=\"contenu\">" +
		...
		"<div class=\"com-widget-window ui-widget ui-widget-content ui-corner-all\">" +
			...
			"<table class=\"com-table\">" +
				"<!-- BEGIN reservation -->" +
				"<tr >" +
					"<td class=\"com-table-td\">{reservation.nproNom}</td>" +
					"<td class=\"com-table-td\">{reservation.stoQuantite}</td>" +
					"<td>{reservation.proUniteMesure}</td>" +
					"<td class=\"com-table-td\">{reservation.prix}</td>" +
					"<td>{sigleMonetaire}</td>" +
				"</tr>" +
				"<!-- END reservation -->" +
				"<tr>" +
					"<td class=\"com-table-td\" colspan=\"3\">Total : </td>" +
					"<td class=\"com-table-td\">{total}</td>" +
					"<td class=\"com-table-td\">{sigleMonetaire}</td>" +
				"</tr>" +
			"</table>" +
		"</div>" +
		"<div class=\"boutons-edition com-widget-header ui-widget ui-widget-header ui-corner-all com-center\">" +
			"<button class=\"ui-state-default ui-corner-all com-button com-center\">Modifier</button>" +	
			"<button class=\"ui-state-default ui-corner-all com-button com-center\">Supprimer</button>" +
		"</div>" +
	"</div>";	
	...
	"<div id=\"contenu\">" +
		"<div class=\"com-widget-window ui-widget ui-widget-content ui-corner-all\">" +
			...
			"<table class=\"com-table\">" +
				"<tr class=\"ui-widget ui-widget-header\">" +
					"<th class=\"com-table-th\">Commande N°</th>" +
					"<th class=\"com-table-th\">Date limite de Réservation</th>" +
					"<th class=\"com-table-th\">Marché</th>	" +
					"<th class=\"com-table-th\"></th>" +
				"</tr>" +
				"<!-- BEGIN reservation -->" +
				"<tr >" +
					"<td class=\"com-table-td\">{reservation.numero}</td>" +
					"<td class=\"com-table-td\">Le {reservation.dateFinReservation} à {reservation.heureFinReservation}H{reservation.minuteFinReservation}</td>" +
					"<td class=\"com-table-td\">Le {reservation.dateMarcheDebut} de {reservation.heureMarcheDebut}H{reservation.minuteMarcheDebut} à {reservation.heureMarcheFin}H{reservation.minuteMarcheFin}</td>" +
					"<td class=\"com-table-td com-td-lien-bouton\">" +
						"<span class=\"btn-visualiser ui-state-default ui-corner-all com-button com-center\" id={reservation.idCommande}>Visualiser</span>" +
					"</td>" +
				"</tr>" +
				"<!-- END reservation -->" +
			"</table>" +	
	...
	this.listeReservationVide =
		"<div id=\"contenu\">" +
			"<div class=\"com-widget-window ui-widget ui-widget-content ui-corner-all\">" +
				"<div class=\"com-widget-header ui-widget ui-widget-header ui-corner-all\">Mes Commandes</div>" +
				"Aucune réservation en cours." +	
				"<span class=\"ui-state-default ui-corner-all com-button com-center\">Anciennes commandes</span>" +
			"</div>" +
		"</div>";	
	...
	this.deconnexion = 	
		"<li class=\"ui-widget-header ui-corner-top\">" +
			"<a href=\"./index.php?m=Identification&amp;v=Deconnexion\" >Déconnexion</a>" +
		"</li>";
...
$(document).ready(function() {
	...
	this.mMenuTemplate = new MenuTemplate();

	this.construct = function() {
		// TODO va chercher le menu dans le server		
		var lMenu = {"modules":[
		                     {"MODULE_LABEL":'Compte',
		                      "MODULE_NOM":'MonCompte',
		                    	 "vues":[{"NOM":"MonCompte","LABEL":"Mon Compte"}]},
	                    	 {"MODULE_LABEL":'Mes Commandes',
			                      "MODULE_NOM":'MonCompte',
			                    	 "vues":[{"NOM":"MesCommandes","LABEL":"Mes Commandes"}]},
	                    	 {"MODULE_LABEL":'Adherents',
			                      "MODULE_NOM":'GestionAdherents',
			                    	 "vues":[{"NOM":"AjoutAdherent","LABEL":"Ajouter un Adhérent"},
			                    	         {"NOM":"ListeAdherent","LABEL":"Liste des Adhérents"}]},
                	         {"MODULE_LABEL":'Commandes',
   		                      "MODULE_NOM":'Commande',
   		                    	 "vues":[{"NOM":"ListeCommande","LABEL":"Liste des commandes"}]},
   	                    	 {"MODULE_LABEL":'Gestion des Commandes',
   			                      "MODULE_NOM":'GestionCommande',
   			                    	 "vues":[{"NOM":"AjoutCommande","LABEL":"Créer une Commande"},
   			                    	         {"NOM":"ListeCommande","LABEL":"Liste des Commandes"}]}]};
		this.afficher(lMenu);
	}	
	...
	this.genererMenu = function(pMenu) {
		...
		lMenu += this.mMenuTemplate.deconnexion;
		lMenu += this.mMenuTemplate.finMenu;
		
		lMenu = $(lMenu);
		
		/*for(i in pMenu.modules) {
			switch(pMenu.modules[i].MODULE_NOM) {
				case 'MonCompte':
					lMenu = this.affectMonCompte(lMenu);
					break;
					
				case 'GestionCommande':
					lMenu = this.affectGestionCommande(lMenu);
					break;
			} 				
		}*/
	...
	this.affectVues = function(pData) {
		if(pData) {
			pData.find('#menu-MonCompte-MesCommandes').click(function() {
				var lListeReservationVue = new ListeReservationVue();
				lListeReservationVue.construct();
				return false;
			});
...
function AjoutCommandeVue() {
		...
		$.post(	"./index.php?m=GestionCommande&v=AjoutCommande",
				function(lResponse) {
					if(lResponse) {
						...
						// TODO Affiche l'erreur de connexion
					}
					...
					if(lResponse.valid) {
						...
						$(lResponse.commande).each(function() {
							...
							if(that.pdtCommande[this.proId]) {
								that.pdtCommande[this.proId].lot.push(lLot);
							} else {			
								var lproduit = new Object();
								...
								$(lResponse.stock).each(function() { 
									if(this.proId == lproduit.proId) {
										if(this.stoQuantite < lproduit.proMaxProduitCommande) {
	...
	this.affectVisualiser = function(pData) {
		pData.find('.btn-visualiser').click(function() {
