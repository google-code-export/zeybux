...
{
	const VUE_CARACTERISTIQUEPRODUIT = "view_caracteristique_produit";
	...
	*/
	...
	/**
	* @name remplir($pCarProIdNomProduit, $pCarId, $pCarNom, $pCarDescription)
	* @param int(11)
	* @param int(11)
	* @param varchar(50)
	* @param text
	...
	*/
	private static function remplir($pCarProIdNomProduit, $pCarId, $pCarNom, $pCarDescription) {
