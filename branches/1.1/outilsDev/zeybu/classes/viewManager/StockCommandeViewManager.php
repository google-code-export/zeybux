...
class StockCommandeViewManager
{
	...
	*/
	...
	/**
	* @name remplirStockCommande($pStoId, $pProIdProducteur, $pDcomId, $pProId, $pStoQuantite)
	* @param int(11)
	* @param int(11)
	* @param int(11)
	* @param int(11)
	...
	*/
	private static function remplir($pStoId, $pProIdProducteur, $pDcomId, $pProId, $pStoQuantite) {
