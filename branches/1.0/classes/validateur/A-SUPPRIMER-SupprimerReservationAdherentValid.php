...
// Fichier : SupprimerReservationAdherentValid.php
//
// Description : Classe SupprimerReservationAdherentValid
//
//****************************************************************
// Inclusion des classes
include_once(CHEMIN_CLASSES_UTILS . "TestFonction.php" );
include_once(CHEMIN_CLASSES_VR . "VRerreur.php" );
include_once(CHEMIN_CLASSES_VR . "SupprimerReservationAdherentVR.php" );
include_once(CHEMIN_CLASSES_VIEW_MANAGER . "CommandeCompleteEnCoursViewManager.php");
include_once(CHEMIN_CLASSES_VIEW_MANAGER . "AdherentViewManager.php");

/**
 * @name SupprimerReservationAdherentVR
 * @author Julien PIERRE
 * @since 26/01/2011
 * @desc Classe représentant une SupprimerReservationAdherentValid
 */
class SupprimerReservationAdherentValid
{
	/**
	* @name validAjout($pData)
	* @return SupprimerReservationAdherentVR
	* @desc Test la validite de l'élément
	*/
	public static function validAjout($pData) {
		$lVr = new SupprimerReservationAdherentVR();
		//Tests inputs
	...
	*/
	public static function validUpdate($pData) {
		$lTestId = SupprimerReservationAdherentValid::validDelete($pData);
		if($lTestId->getValid()) {
			$lVr = new SupprimerReservationAdherentVR();
			//Tests inputs
			if(!isset($pData['id_commande'])) {
