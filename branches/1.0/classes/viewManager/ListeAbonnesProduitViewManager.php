...
class ListeAbonnesProduitViewManager
{
	...
	*/
	...
	/**
	* @name remplir($pCptAboIdProduitAbonnement, $pCptAboIdCompte, $pAdhNumero, $pCptLabel, $pAdhNom, $pAdhPrenom, $pCptAboQuantite)
	* @param int(11)
	* @param int(11)
	* @param varchar(20)
	* @param varchar(30)
	...
	*/
	private static function remplir($pCptAboIdProduitAbonnement, $pCptAboIdCompte, $pAdhNumero, $pCptLabel, $pAdhNom, $pAdhPrenom, $pCptAboQuantite) {
