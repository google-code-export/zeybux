...
if (!function_exists('spyc_dump_file')) {
  /**
   * Enregistre des données au format YAML dans un fichier
   * @param string $pFile Chemin du fichier YAML à créer.
   * @param YAML $pData Données au format YAML.
   */
  function spyc_dump_file ($pFile,$pData) {
  	file_put_contents($pFile, Spyc::YAMLDump($pData));
  }
}
