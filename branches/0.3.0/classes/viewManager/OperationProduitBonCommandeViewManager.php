...
class OperationProduitBonCommandeViewManager
{
	...
	*/
	...
	/**
	* @name selectInfoBonCommandeProduit($pIdCommande,$pIdProducteur,$pIdProduit))
	* @param integer
	* @return array(OperationProduitBonCommandeViewVO)
	* @desc Récupères toutes les lignes de la table ayant pour IdCommande $pIdCommande, IdProducteur $pIdProducteur et IdProduit $pIdProduit. Puis les renvoie sous forme d'une collection de OperationProduitBonCommandeViewVO
	*/
	public static function selectInfoBonCommandeProduit($pIdCommande,$pIdProducteur,$pIdProduit) {
		return OperationProduitBonCommandeViewManager::recherche(
	...
	*/
	private static function remplir($pComId, $pProIdProducteur, $pProId, $pOpeId, $pProUniteMesure, $pNproNom, $pOpeMontant) {
		...
		$lOperationProduitBonCommande->setOpeId($pOpeId);
