...
class ListeReservationArchiveViewManager
{
	...
	*/
	public static function recherche( $pTypeRecherche, $pTypeCritere, $pCritereRecherche, $pTypeTri, $pCritereTri ) {
		...
		$lRequete = DbUtils::prepareRequeteRecherche(ListeReservationArchiveViewManager::VUE_LISTERESERVATIONARCHIVE, $lChamps, $lFiltres, $lTypeFiltre, $lTris);
	...
	/**
	* @name remplirListeReservationArchive($pAdhId, $pAdhNumero, $pAdhIdCompte, $pAdhSuperZeybu, $pComId, $pComNumero, $pComDateMarcheDebut, $pComDateMarcheFin, $pComDateFinReservation, $pComArchive)
	* @param int(11)
	* @param varchar(5)
	* @param int(11)
	* @param tinyint(1)
