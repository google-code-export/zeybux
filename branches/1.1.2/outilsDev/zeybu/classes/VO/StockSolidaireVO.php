...
class StockSolidaireVO  extends DataTemplate
{
	...
	*/
	...
	/**
	* @var datetime
	* @desc DateCeation de la StockSolidaireVO
	*/
	protected $mDateCeation;
	...
	* @name getDateCeation()
	* @return datetime
	* @desc Renvoie le membre DateCeation de la StockSolidaireVO
	*/
	public function getDateCeation() {
		return $this->mDateCeation;
	}

	/**
	* @name setDateCeation($pDateCeation)
	* @param datetime
	* @desc Remplace le membre DateCeation de la StockSolidaireVO par $pDateCeation
	*/
	public function setDateCeation($pDateCeation) {
		$this->mDateCeation = $pDateCeation;
	}
