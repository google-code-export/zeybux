;function ProduitsBonDeLivraisonValid() { 
	this.validAjout = function(pData) { 
		...
		if(!pData.total.checkLength(0,12) || pData.total > 999999999.99) {lVR.valid = false;lVR.total.valid = false;var erreur = new VRerreur();erreur.code = ERR_101_CODE;erreur.message = ERR_101_MSG;lVR.total.erreurs.push(erreur);}
